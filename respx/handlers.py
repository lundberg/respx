...
class TransportHandler:
    ...
    def __call__(self, request: httpx.Request) -> httpx.Response:
        if not isinstance(request.stream, httpx.SyncByteStream):  # type: ignore[has-type] # pragma: nocover
...
class AsyncTransportHandler:
    ...
    async def __call__(self, request: httpx.Request) -> httpx.Response:
        if not isinstance(request.stream, httpx.AsyncByteStream):  # type: ignore[has-type] # pragma: nocover
